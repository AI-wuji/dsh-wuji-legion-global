...
let o=officerAdviceProjection.apply(officerAdviceProjection.init(),{type:'wuji/officer-advice/change',data:{adviceId:'a1',patch:{officer:'白帽',content:'风险',evidence:'e1',userDecision:'pending',affectedRequirement:'u1'}}});
